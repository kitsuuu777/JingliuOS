...
hl.bind(mainMod .. " + H",          hl.dsp.exec_cmd("sh -c 'cd \"$HOME\" && exec honkers-railway-launcher'"))
...
hl.bind(
    mainMod .. " + Print",
    hl.dsp.exec_cmd('grim - | satty -f - --copy-command wl-copy')
)
...
hl.bind(
    mainMod .. " + G",
    hl.dsp.focus({ workspace = "name:gaming" })
)
...
-- SUPER + SHIFT + 1-9 moves the active window
